...
const PROJECTS: Project[] = [
  {
    ...
    stack: ["Next.js", "Python", "PyTorch", "Postgres", "AWS"],
    href: "/#contact",
  ...
  },
  {
    ...
    stack: ["Next.js", "Node", "Postgres", "M-Pesa Daraja"],
    href: "/#contact",
  ...
  },
  {
    ...
    blurb: "POS system built around how Kenyan retailers actually operate.",
    description:
      "A retail point-of-sale system covering sales, inventory, receipts, and reporting. Designed for shops and restaurants that need M-Pesa-first checkout, offline-capable terminals, and dashboards their accountants can read.",
    highlights: [
      "M-Pesa STK Push checkout at point of sale",
      "Stock control + auto-reordering thresholds",
      "Multi-terminal sync with offline fallback",
      "Owner dashboard with daily/weekly/monthly views",
    ],
    stack: ["React", "Node", "PostgreSQL", "M-Pesa Daraja"],
    href: "/#contact",
